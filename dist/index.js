...
var wrapInterceptors = function wrapInterceptors(http, _ref) {
  ...
  http.interceptors.request.use(function (req) {
    ...
    if (requestInterceptors) requestInterceptors(_objectSpread(_objectSpread({}, req), {}, {
      isApijson: isApijson
    }));
    return req;
  }); // 响应拦截
...
function axiosInstance(_ref2) {
  ...
  return wrapInterceptors(axios_default.a.create({
    baseURL: baseURL,
    timeout: 30000,
...
function http(_ref3, requestInterceptors, responseInterceptors) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (isApijson) {
      ...
      requestData.url = "".concat(url, "?appkey=").concat(queryportAppkey, "&sign=").concat(sign).concat(queryportAppType ? "&appType=".concat(queryportAppType) : "");
...
http.create = function (_ref4, requestInterceptors) {
  ...
  return function () {
    return http(_objectSpread(_objectSpread({}, arguments[0]), {}, {
